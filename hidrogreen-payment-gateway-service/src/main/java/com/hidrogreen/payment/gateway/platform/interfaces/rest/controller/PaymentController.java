...
public class PaymentController {
  ...
  public void paymentSuccess(@RequestParam("paymentId") String providerPaymentId, // Este es el paymentId de PayPal
    ...
    try {
      ...
      String frontendSuccessUrl = "http://localhost:8086/payment-success?internalPaymentId=" + completedPayment.getId().getValue().toString();
      ...
      String frontendErrorUrl = "http://localhost:8086/payment-error?error=" + e.getMessage();
  ...
  public void paymentCancel(@RequestParam(value = "token", required = false) String token, // PayPal a veces envía 'token' que es el paymentId
    ...
    String frontendCancelUrl = "http://localhost:8086/payment-cancelled";
