package com.hidrogreen.user_service.iam.infrastructure.authorization.sfs.pipeline;

import com.hidrogreen.user_service.shared.infrastructure.config.ServiceTokenConfig;
...
public class ServiceAuthorizationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        if (serviceToken != null && serviceToken.equals(internalServiceToken)) {
            LOGGER.info("Internal service token validated successfully");
