package com.hidrogreen.treatment_activity_service.infrastructure.config;
...
public class RabbitMQConfig {
    ...
    public RabbitAdmin rabbitAdmin(ConnectionFactory connectionFactory) {
        logger.info("Creating RabbitAdmin bean");
    ...
    public String getTreatmentRoutingKey() {
        return treatmentRoutingKey;
    }
}
