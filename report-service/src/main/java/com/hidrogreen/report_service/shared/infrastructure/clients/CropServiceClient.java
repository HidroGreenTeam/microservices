package com.hidrogreen.report_service.shared.infrastructure.clients;
...
@FeignClient(
    name = "crop-service", 
    configuration = com.hidrogreen.report_service.shared.infrastructure.config.FeignConfig.class
)
public interface CropServiceClient {
    ...
    CropResponse getCropById(@PathVariable("cropId") Long cropId);
