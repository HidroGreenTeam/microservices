package com.hidrogreen.treatment_service.shared.infrastructure.security.feign;

import com.hidrogreen.treatment_service.shared.infrastructure.security.jwt.JwtTokenService;
...
public class ServiceTokenFeignInterceptor implements RequestInterceptor {
    ...
    private static final String SERVICE_NAME = "treatment-service";
