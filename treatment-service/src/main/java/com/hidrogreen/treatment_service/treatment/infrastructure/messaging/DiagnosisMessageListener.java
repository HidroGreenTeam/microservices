...
public class DiagnosisMessageListener {
    ...
    public void handleDiagnosisMessage(Map<String, Object> message) {
        ...
        String diseaseType = (String) message.get("predicted_class");
        Boolean diseaseDetected = (Boolean) message.get("disease_detected");
        Boolean requiresTreatment = (Boolean) message.get("requires_treatment");
        ...
        if (diseaseDetected && requiresTreatment) {
